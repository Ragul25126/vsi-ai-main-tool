...
export default function QAChecklistClient({ sections }: { sections: QASection[] }) {
 ...
 {/* Tester bar */}
 <div className="rounded-panel border border-gray-200 bg-card p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
 ...
 className="w-full sm:max-w-xs rounded-lg border border-gray-300 bg-gray-100 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-line-strong focus:outline-none"
 />
 </div>
 <div className="flex flex-wrap gap-2 shrink-0">
 <button onClick={exportMarkdown} className="rounded-lg bg-ink px-3 py-2 text-xs font-semibold text-white hover:bg-ink-2">Export Markdown</button>
 ...
 {/* Summary */}
 <div className="rounded-panel border border-gray-200 bg-card p-4">
 ...
 {/* Sections */}
 {sections.map((s) => (
 <div key={s.id} className="rounded-panel border border-gray-200 bg-card overflow-hidden">
 ...
 className="mt-2 w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2 text-xs text-gray-900 placeholder-gray-400 focus:border-line-strong focus:outline-none"
 />
 )}
 </div>
 );
