...
export default async function ClientTasksPage({
 ...
 <span className="text-ink font-bold">Execution Tickets</span>
 </div>
 <div className="flex items-center justify-between gap-4 flex-wrap">
 <div>
 <h1 className="text-2xl font-heading font-semibold text-ink tracking-tight">Client Task Pipeline</h1>
 ...
 <div className="bg-[#121215] border border-white/[0.08] p-4 rounded-panel shadow-overlay">
 <TaskFilterBar
 counts={counts}
 groups={[
 ...
 <p className="text-lg font-heading font-bold text-ink mb-1">
 ...
 <div key={key} className="bg-[#121215] border border-white/[0.08] rounded-panel p-6 shadow-overlay space-y-4">
 <div className="flex items-center justify-between border-b border-line pb-3">
 <h2 className="text-sm font-heading font-bold text-ink">
 {group.href ? (
 <Link href={group.href} className="hover:text-ink transition-colors flex items-center gap-2">
 ...
 <span className="rounded-full bg-card/5 border border-line px-2.5 py-0.5 text-caption font-mono font-bold text-ink-3">
