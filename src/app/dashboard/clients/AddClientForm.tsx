...
export default function AddClientForm({ agencyId }: { agencyId: string }) {
 ...
 type="submit"
 disabled={loading}
 className="w-full rounded-lg bg-ink px-4 py-2 text-sm font-medium text-white hover:bg-ink-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
 >
