...
// Canvas-only particle background (no overlay text/buttons)
export const AetherFlowCanvas = () => {
            ...
            for (let a = 0; a < particles.length; a++) {
                for (let b = a; b < particles.length; b++) {
                    ...
                    if (distance < (canvas.width / 7) * (canvas.height / 7)) {
                        ...
                        ctx.strokeStyle =
                            mouse.x !== null && distance_mouse_a < mouse.radius
...
// Full standalone hero with text overlay (original component)
const AetherFlowHero = () => {
    ...
    return (
        <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
            <canvas ref={canvasRef} className="absolute top-0 left-0 w-full h-full" style={{ background: "black" }} />
